...
SOURCES = [
    ...
    "sheet_types/ht_variants/hard_time_components_status_content_gated_scanned.py",
    ...
    "sheet_types/ht_variants/ht_list_report.py",
    "sheet_types/ht_variants/hard_time_status_mpd_cert_fin.py",
    "sheet_types/ht_variants/tci_list.py",
    ...
    "sheet_types/ht_variants/tci_status_dense_broken_font.py",
    ...
    "sheet_types/ht_variants/ht_ruled_grid_mpd_interval_remaining_scanned.py",
    "sheet_types/ht_variants/component_inventory_ht_llp_scanned.py",
    "sheet_types/ht_variants/al_development_controlled_items_list_scanned.py",
    ...
    "sheet_types/ht_variants/hard_time_components_status_pt_ruled_scanned.py",
    "sheet_types/ht_variants/hard_time_component_status_amp_interval_ruled_scanned.py",
