...
from sheet_types.ht_variants import (
    ...
    hard_time_components_status_content_gated_scanned,
    amos_scanned, aircraft_ext_equipment_list_scanned,
    aircraft_inspection_report_scanned,
    ...
    components_no_controlled_status_letter,
    ...
    ht_list_report_scanned,
    time_controlled_component_status_task_block_grid_scanned,
    hard_time_components_status_requirement_grouped_scanned,
)
